...
printHAPIVersion()
{
...

    {
        ...
        msg = "Houdini version: ";
        snprintf(version, 32, "%d.%d.%d", i, j, k);
        msg += version;
        ...
        {
            msg += ", expected: ";
            snprintf(version, 32, "%d.%d.%d", HAPI_VERSION_HOUDINI_MAJOR,
...

    {
        ...
        snprintf(version, 32, "%d.%d (API: %d)", i, j, k);
        msg += version;
...
initializePlugin(MObject obj)
{
    ...
    snprintf(engine_version, 32, "%d.%d (API: %d)",
             HAPI_VERSION_HOUDINI_ENGINE_MAJOR,
